...
class Model:
  ...
  def __init__(self, model_id=None, name=None, fields=None, templates=None, css='', model_type=FRONT_BACK, latex_header=None, latex_footer=None):
    ...
    if latex_header is None:
      self.latex_header = """\\documentclass[12pt]{article} None:
